...
export default function FechamentoDelivery() {
  ...
  useEffect(() => {
    ...
    const buscarFechamentoBalcaoDia = async () => {
      try {
        ...
        const fechamento = await criarFechamento('delivery', { vendedor: 'delivery' });
  ...
  }, [statusFechamento, vendaDelivery])
  ...
  const finalizarFechamento = async () => {
    ...
    const dados = { totalSistema: vendaDelivery?.resultado?.a_vista ?? 0, totalInformado: totalContado ?? 0 };
    try {
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.pageHeader}>
          ...
          <div className={styles.pageHeaderLeft}>
            ...
            <div>
              ...
              <h1 className={styles.pageTitulo}>Fechamento de Caixa Delivery</h1>
            </div>
          </div>
      ...
      :
        ...
        {vendaDelivery?.quantidade > 0 && fechamentoAtual?.status === 'aberto' ? 
        (
            ...
            <div className={styles.resumoCards}>
              ...
              <div className={styles.resumoCard}>
                ...
                <div>
                  ...
                  <strong className={styles.resumoCardValor}>{formatarMoeda(vendaDelivery?.total ?? 0)}</strong>
                </div>
              </div>
              ...
              <div className={styles.resumoCard}>
                ...
                <div>
                  ...
                  <strong className={styles.resumoCardValor}>{vendaDelivery?.quantidade ?? 0}</strong>
                </div>
              </div>
        ...
        (
            <div className={styles.fechadoBanner}>
              ...
              <div>
                ...
                <p className={styles.fechadoSubtitulo}>Delivery · Status: Nenhuma movimentação registrada até o momento. </p>
              </div>
            </div>
        )
        :
          ...
          <div className={styles.fechadoWrapper}>
            <div className={styles.fechadoBanner}>
              ...
              <div>
                ...
                <p className={styles.fechadoSubtitulo}>Status fechamento delivery: <strong className={styles.statusBadge}>{fechamentoAtual?.status}</strong></p>
              </div>
            </div>
            ...
            <div className={styles.fechadoGrid}>
              <div className={styles.fechadoCard}>
                ...
                <strong className={styles.fechadoCardValor}>{formatarMoeda(vendaDelivery?.total ?? 0)}</strong>
              </div>
              <div className={styles.fechadoCard}>
                ...
                <strong className={styles.fechadoCardValor}>{vendaDelivery?.quantidade ?? 0}</strong>
              </div>
              <div className={styles.fechadoCard}>
                <MoneyIcon size={22} weight="duotone" className={styles.fechadoCardIcone} />
                <p className={styles.fechadoCardLabel}>Vendas à vista</p>
                <strong className={styles.fechadoCardValor}>{formatarMoeda(vendaDelivery?.resultado?.a_vista ?? 0)}</strong>
              </div>
              <div className={styles.fechadoCard}>
